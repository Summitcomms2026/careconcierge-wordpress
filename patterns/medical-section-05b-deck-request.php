<?php
/**
 * Title: Medical — Section 05b Request the Deck
 * Slug: careconcierge/medical-section-05b-deck-request
 * Categories: careconcierge
 * Description: Other Medical deck request. Same form / states / wiring as the master; copy adapted from WebCopy_OtherMedical_Page.docx. The specialist deck PDF is not yet wired into careconcierge_deck_url_for_market() so for now market-keyed downloads return the existing surgeons editions; the "Other" state remains the safe path until specialist editions are uploaded.
 * Inserter: yes
 */
...
<section id="deck-request" class="wp-block-group cc-section cc-section--deck has-ink-blue-color has-soft-cloud-background-color has-text-color has-background">
	...
	<div class="cc-deck-grid">
		...
		<div class="cc-deck__copy">
			<p class="cc-eyebrow cc-reveal">The Private Specialist Practice Deck</p>
			<h2 class="cc-deck__headline cc-reveal">Request the private specialist practice deck.</h2>
			<div class="cc-deck__body cc-reveal">
				<p>A serious specialist enquiry rarely arrives casually. The patient has researched the condition, compared clinics, checked credentials, worried about outcomes, considered the cost, then waited until the question felt real enough to ask.</p>
			</div>
			...
			<ol class="cc-deck-points cc-reveal-group" role="list">
				<li class="cc-deck-points__item cc-reveal">
					...
					<div class="cc-deck-points__text">
						...
						<p class="cc-deck-points__body">The deck explains why, in regulated private medicine, the decisive advantage is no longer simply what you advertise. It is how quickly, intelligently and safely your practice responds once the patient reaches out.</p>
					</div>
				</li>
				<li class="cc-deck-points__item cc-reveal">
					...
					<div class="cc-deck-points__text">
						...
						<p class="cc-deck-points__body">After-hours messages, delayed callbacks, vague fee questions, unqualified enquiries and lapsed conversations all carry commercial consequence. The deck maps the leak most clinics feel but rarely measure.</p>
					</div>
				</li>
				<li class="cc-deck-points__item cc-reveal">
				...
				<li class="cc-deck-points__item cc-reveal">
					...
					<div class="cc-deck-points__text">
						<h3 class="cc-deck-points__title">What changed inside an established specialist practice</h3>
		...
		<div class="cc-deck__visual">
			<figure class="cc-deck__artwork cc-reveal cc-reveal--from-right">
				<img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/photography/deck.jpg" alt="The CareConcierge specialist practice deck &mdash; confidential commercial briefing" loading="lazy" decoding="async" />
			</figure>

			<aside class="cc-deck-form cc-reveal cc-reveal--from-bottom" aria-labelledby="cc-deck-form-title-medical">
				<!-- Default (form) state -->
				<div class="cc-deck-form__state cc-deck-form__state--form" data-cc-state="form">
					<header class="cc-deck-form__masthead">
						...
						<h3 id="cc-deck-form-title-medical" class="cc-deck-form__title">Request the private specialist practice deck</h3>
					...
					Form behaviour (kept in comments so this remains public-facing prose):
					  ...
					  - Specialist editions of the deck are not yet uploaded to
					    ...
					    once specialist PDFs are supplied. The "Other" state
					    is safe to use today and tells the requester we will
					...
					<form class="cc-deck-form__form" novalidate>
						...
						<div class="cc-deck-form__field">
							<label for="cc-deck-name-medical">Full name <span class="cc-deck-form__required" aria-hidden="true">*</span></label>
							<input id="cc-deck-name-medical" name="full_name" type="text" required autocomplete="name" placeholder="Dr / Mr / Ms / First and last name" />
						</div>

						<div class="cc-deck-form__field">
							<label for="cc-deck-practice-medical">Practice name <span class="cc-deck-form__required" aria-hidden="true">*</span></label>
							<input id="cc-deck-practice-medical" name="practice_name" type="text" required autocomplete="organization" placeholder="Your clinic or company name" />
						</div>

						<div class="cc-deck-form__row">
							<div class="cc-deck-form__field">
								<label for="cc-deck-role-medical">Role <span class="cc-deck-form__required" aria-hidden="true">*</span></label>
								<select id="cc-deck-role-medical" name="role" required>
						...
						<div class="cc-deck-form__field">
							<label for="cc-deck-website-medical">Practice website <span class="cc-deck-form__required" aria-hidden="true">*</span></label>
							<input id="cc-deck-website-medical" name="practice_website" type="text" required autocomplete="url" placeholder="yourpractice.com" />
						</div>

						<div class="cc-deck-form__field">
							<label for="cc-deck-email-medical">Email address <span class="cc-deck-form__required" aria-hidden="true">*</span></label>
							<input id="cc-deck-email-medical" name="email" type="email" required autocomplete="email" placeholder="work email preferred" />
						</div>

						<div class="cc-deck-form__field">
							<label for="cc-deck-challenge-medical">Main enquiry challenge <span class="cc-deck-form__required" aria-hidden="true">*</span></label>
							<select id="cc-deck-challenge-medical" name="challenge" required>
						...
						<div class="cc-deck-form__field">
							<label for="cc-deck-volume-medical">Monthly enquiry volume <span class="cc-deck-form__required" aria-hidden="true">*</span></label>
							<select id="cc-deck-volume-medical" name="volume" required>
