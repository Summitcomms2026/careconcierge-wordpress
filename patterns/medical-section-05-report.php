<?php
/**
 * Title: Medical — Section 05 The Owner's View
 * Slug: careconcierge/medical-section-05-report
 * Categories: careconcierge
 * Description: Other Medical Owner's View. Copy is identical to the master per WebCopy_OtherMedical_Page.docx — duplicated as a separate pattern so each vertical can evolve independently.
 * Inserter: yes
 */
?>
	...
	<div class="cc-report-grid">
		...
		<div class="cc-report-visual">
			<figure class="cc-report-visual__photo cc-reveal cc-reveal--from-right">
				<img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/medical/medical_ownersview.jpg" alt="A specialist principal at calm focus, the moment a monthly report lands" loading="lazy" decoding="async" />
			</figure>
