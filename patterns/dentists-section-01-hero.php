<?php
/**
 * Title: Dentists — Section 01 Hero
 * Slug: careconcierge/dentists-section-01-hero
 * Categories: careconcierge
 * Description: Dental & Ortho hero. Mirrors the master surgeons hero structure, with copy adapted from WebCopy_DentalOrtho_Page.docx and the editorial correction "prospects sit quietly" applied.
 * Inserter: yes
 */
?>
...
<section id="hero" class="wp-block-group cc-section cc-section--hero has-ink-blue-color has-eucalyptus-background-color has-text-color has-background">
	...
	<div class="cc-hero-grid">
		<div class="cc-hero-grid__main cc-reveal">
			...
			<h1 class="cc-hero-headline">The invisible layer behind the more responsive private dental practice.</h1>
			...
			<p class="cc-hero-subhead cc-hero-subhead--secondary">CareConcierge protects the moment between patient interest and booked consultation &mdash; the moment where even premium practices quietly lose revenue, reputation and control. And prospects sit quietly in your database like <strong>sleeping beauties</strong>, waiting to be awoken.</p>
			<a class="cc-button cc-button--ghost cc-hero-cta" href="#walkthrough">Book Your Meeting <span aria-hidden="true">&rarr;</span></a>
			<p class="cc-hero-qualifier">Patient-Intent Infrastructure for Private Dentistry.</p>
		</div>
		<div class="cc-hero-visual cc-reveal-group">
			<figure class="cc-hero-montage__primary cc-img cc-reveal">
				<img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/dentists/dental_hero1.jpg" alt="A patient and dentist reviewing an X-ray together — the moment patient intent becomes a conversation" loading="eager" decoding="async" />
			</figure>
