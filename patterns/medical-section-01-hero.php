<?php
/**
 * Title: Medical — Section 01 Hero
 * Slug: careconcierge/medical-section-01-hero
 * Categories: careconcierge
 * Description: Other Medical hero. Mirrors the master surgeons hero structure, with copy adapted from WebCopy_OtherMedical_Page.docx and the editorial correction "prospects sit quietly" applied.
 * Inserter: yes
 */
?>
...
<section id="hero" class="wp-block-group cc-section cc-section--hero has-ink-blue-color has-eucalyptus-background-color has-text-color has-background">
	...
	<div class="cc-hero-grid">
		<div class="cc-hero-grid__main cc-reveal">
			...
			<h1 class="cc-hero-headline">The invisible layer behind the more responsive private specialist practice.</h1>
			...
			<p class="cc-hero-subhead cc-hero-subhead--secondary">CareConcierge protects the moment between patient interest and booked consultation &mdash; the moment where even premium clinics quietly lose revenue, reputation and control. And prospects sit quietly in your database like <strong>sleeping beauties</strong>, waiting to be awoken.</p>
			<a class="cc-button cc-button--ghost cc-hero-cta" href="#walkthrough">Book Your Meeting <span aria-hidden="true">&rarr;</span></a>
			<p class="cc-hero-qualifier">Patient-Intent Infrastructure for Private Specialist Medicine.</p>
		</div>
		<div class="cc-hero-visual cc-reveal-group">
			<figure class="cc-hero-montage__primary cc-img cc-reveal">
				<img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/medical/medical_hero1.jpg" alt="A consultation in a private specialist clinic — the moment patient intent meets the practice" loading="eager" decoding="async" />
			</figure>
