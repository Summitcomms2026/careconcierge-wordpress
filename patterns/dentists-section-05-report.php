<?php
/**
 * Title: Dentists — Section 05 The Owner's View
 * Slug: careconcierge/dentists-section-05-report
 * Categories: careconcierge
 * Description: Dental & Ortho Owner's View. Copy is identical to the master per WebCopy_DentalOrtho_Page.docx — duplicated as a separate pattern so each vertical can evolve independently.
 * Inserter: yes
 */
?>
	...
	<div class="cc-report-grid">
		...
		<div class="cc-report-visual">
			<figure class="cc-report-visual__photo cc-reveal cc-reveal--from-right">
				<img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/dentists/dental_ownersview.jpg" alt="A dental principal at calm focus, the moment a monthly report lands" loading="lazy" decoding="async" />
			</figure>
