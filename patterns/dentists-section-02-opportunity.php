...
<section id="opportunity" class="wp-block-group cc-section cc-section--opportunity has-ink-blue-color has-soft-cloud-background-color has-text-color has-background">
	...
	<div class="cc-opportunity-grid">
		<div class="cc-opportunity-text cc-reveal cc-reveal--from-left">
			...
			<p>Private dental practices do not lose every opportunity in public. The real leak is quieter. It happens after hours, between patients, across inboxes, in hesitant WhatsApp messages, cold web enquiries, half-qualified leads, and patient conversations that never reach the treatment coordinator with enough context to act.</p>
		...
		<figure class="cc-img cc-img--portrait cc-reveal cc-reveal--from-right">
			<img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/dentists/dental_hiddenleak.jpg" alt="A quiet dental practice moment — the after-hours space where a patient enquiry sits unanswered" loading="lazy" decoding="async" />
		</figure>
	</div>
