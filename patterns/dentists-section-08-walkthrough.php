<?php
/**
 * Title: Dentists — Section 08 The Founder Briefing
 * Slug: careconcierge/dentists-section-08-walkthrough
 * Categories: careconcierge
 * Description: Dental & Ortho closing section. Same Calendly widget, same fallback email. Adjusted to "front desk or treatment coordinator" per WebCopy_DentalOrtho_Page.docx.
 * Inserter: yes
 */
?>
	...
	<div class="cc-walk-grid">
		<div class="cc-walk-grid__hero">
			<figure class="cc-walk__photo cc-reveal cc-reveal--from-left">
				<img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/photography/founder-briefing.jpg" alt="A founder at the table during a briefing session &mdash; laptop, notebook, calm focus" loading="lazy" decoding="async" />
			</figure>
			<div class="cc-walk__intro cc-reveal cc-reveal--from-right">
				...
				<p>In thirty minutes, we look at how patients currently enter your world, where response breaks down, how much burden sits with the front desk or treatment coordinator, where dormant value may already sit in your enquiry history, and whether CareConcierge is likely to be useful. If it is not the right fit, we will say so.</p>
