<?php
/**
 * Title: Medical — Section 08 The Founder Briefing
 * Slug: careconcierge/medical-section-08-walkthrough
 * Categories: careconcierge
 * Description: Other Medical closing section. Same Calendly widget, same fallback email. Copy is identical to the master per WebCopy_OtherMedical_Page.docx.
 * Inserter: yes
 */
?>
